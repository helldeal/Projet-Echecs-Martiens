...
class ControleurPictureRight(vue:VueNewJeu, players:Skins,skin:VBox):EventHandler<ActionEvent> {
    ...
    override fun handle(p0: ActionEvent?) {
        if (skin==vue.skinsP1){
            if (vue.cpt1==players.getSize()-1){
                ...
                if (vue.cpt1+1==players.getSize()-1){
                    vue.cpt1=0
                }
                else{
                    vue.cpt1+=3
        ...
        if (skin==vue.skinsP2)
            if (vue.cpt2==players.getSize()-1){
                ...
                if (vue.cpt2+1==players.getSize()-1){
                    vue.cpt2=0
                }
                else{
                    vue.cpt2+=2
