...
class VueMenu(): BorderPane() {
    ...
    init {
        ...
        this.bas = VBox()
        this.ljeu= Label("Échecs Martiens")
        ...
        this.bquit= Button("Quitter le Jeu")
        ...
        bquit.style="-fx-background-color: None; -fx-background-radius: 5px; -fx-border-radius: 5px;"
        bquit.textFill=Color.WHITE
        ...
        this.style= ("-fx-background-image: url('file:src/main/resources/projet/echecmartien/spacegif3.gif'); -fx-background-size:cover;")

        this.right=screenSizeBox
        this.center=hautetbas
        this.left=empty
        bas.children.addAll(blauch,bcharge,brule,bquit) //TODO
        haut.center=ljeu
