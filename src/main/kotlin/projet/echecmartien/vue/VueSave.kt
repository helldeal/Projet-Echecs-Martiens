...
class VueSave():GridPane() {
    ...
    init {
        ...
        this.titre= Label("Sauvegardez votre partie")
        this.back= Button("Retour")

        // LOAD 1
        this.charge1= GridPane()
        this.nomP1= Label("Emplacement Disponible")
        this.j1P1= Label("")
        this.j2P1=Label("")
        this.dateP1=Label("")
        this.dureP1=Label("")
        ...
        this.nomP2= Label("Emplacement Disponible")
        this.j1P2= Label("")
        this.j2P2=Label("")
        this.dateP2=Label("")
        this.dureP2=Label("")
        ...
        this.nomP3= Label("Emplacement Disponible")
        this.j1P3= Label("")
        this.j2P3=Label("")
        this.dateP3=Label("")
        this.dureP3=Label("")
        ...
        this.nomP4= Label("Emplacement Disponible")
        this.j1P4= Label("")
        this.j2P4=Label("")
        this.dateP4=Label("")
        this.dureP4=Label("")
        ...
        fun paddingMargin(){
            ...
            dateP1.padding= Insets(0.0,0.0,0.0,150.0)
            dureP1.padding=Insets(0.0,0.0,0.0,70.0)

            dateP4.padding= Insets(0.0,0.0,0.0,150.0)
            dureP4.padding=Insets(0.0,0.0,0.0,70.0)


            dateP2.padding= Insets(0.0,0.0,0.0,150.0)
            dureP2.padding=Insets(0.0,0.0,0.0,70.0)


            dateP3.padding= Insets(0.0,0.0,0.0,150.0)
            dureP3.padding=Insets(0.0,0.0,0.0,70.0)
        ...
        fun colconstraint(){
            ...
            col12.percentWidth=25.0
            col13.percentWidth=25.0
            charge3.columnConstraints.addAll(col11,col12,col13)

            charge4.prefHeight=150.0
            col11.percentWidth=50.0
            col12.percentWidth=25.0
            col13.percentWidth=25.0
            charge4.columnConstraints.addAll(col11,col12,col13)

            charge2.prefHeight=150.0
            col11.percentWidth=50.0
            col12.percentWidth=25.0
            col13.percentWidth=25.0
            charge2.columnConstraints.addAll(col11,col12,col13)

            charge1.prefHeight=150.0
            col11.percentWidth=50.0
            col12.percentWidth=25.0
            col13.percentWidth=25.0
            charge1.columnConstraints.addAll(col11,col12,col13)
        }
        colconstraint()
